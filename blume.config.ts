...
//
// Usage:
//   pnpm docs:dev     → blume dev   (local docs site)
//   pnpm docs:build   → blume build (static site → .blume/dist by default)
//
// Blume is NOT part of the production Worker build. `pnpm deploy` does not
// invoke Blume. The generated site is gitignored (see .gitignore).

import { defineConfig } from 'blume';

export default defineConfig({
  title: 'Reader — Documentation',
  description:
    'Personal research library: capture, read, annotate, and AI-chat over web articles and PDFs. Architecture, decisions, operations, and knowledge for the Reader project.',
