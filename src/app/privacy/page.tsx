...
export const metadata = {
  title: "Privacy — Web Annotator",
  description: "What Web Annotator stores about your library, articles, and chat queries.",
};
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12 text-sm leading-7">
      ...
      <ul className="mt-2 list-disc space-y-1 pl-5">
        ...
        <li>PDFs themselves live in Cloudflare R2; downloads proxy through an authenticated route.</li>
      ...
      <ul className="mt-2 list-disc space-y-1 pl-5">
        ...
        <li>The Chrome extension does not collect telemetry; it only talks to your configured Web Annotator backend.</li>
      </ul>

      <h2 className="mt-8 text-base font-semibold">Chat with your library</h2>
      <p className="mt-2">
        When you ask a chat question, the relevant article body + your question
        are sent to the AI provider you&apos;ve configured. Their privacy policy
        applies. The local-AI bridge sends nothing externally.
      </p>

      <h2 className="mt-8 text-base font-semibold">Public shares</h2>
      <p className="mt-2">
        Articles you mark for public share are reachable to anyone with the
        URL; everything else is gated to your signed-in session.
      </p>

      <h2 className="mt-8 text-base font-semibold">Deletion</h2>
      <p className="mt-2">
        Delete articles individually from the library, or contact the
        maintainer to remove all of your data.
      </p>
    </main>
  );
}
