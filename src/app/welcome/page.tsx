...
export const metadata: Metadata = {
  title: 'Web Annotator — read, annotate, and chat with the web',
  description:
    'Save any article or PDF into one library, read it in a clean typography view with persistent highlights, and chat with your sources using AI.',
  alternates: { canonical: '/welcome' },
  openGraph: {
    title: 'Web Annotator — read, annotate, and chat with the web',
    description:
      'Save any article or PDF into one library, read it in a clean view with highlights, and chat with your sources using AI.',
    type: 'website',
    url: '/welcome',
  },
  twitter: {
    ...
    title: 'Web Annotator — read, annotate, and chat with the web',
    description:
      'Save any article or PDF into one library, read it with highlights, and chat with your sources using AI.',
  },
};
