#!/usr/bin/env node
// Validate docs/ link integrity and structure for the Reader repository.
//
// What it checks:
...
//      http(s) links and mailto: are skipped, with an optional allowlist for
//      known-good external URLs that we do not fetch).
